  ...
  return (
    <div className='w-[25%] h-full p-2 flex-col gap-3 text-white hidden lg:flex'>
      ...
      <div className='bg-[#121212] h-[85%] rounded'>
        ...
        <p className='font-light text-sm text-gray-300'>Let’s make some musical magic together!</p>
        ...
        <div className='p-4 bg-[#242424] m-2 rounded-lg font-semibold flex flex-col items-start gap-2 mt-4'>
